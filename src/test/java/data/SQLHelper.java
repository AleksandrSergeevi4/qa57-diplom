...
public class SQLHelper {
    ...
    public static String getCreditStatusOperation() {
        ...
        var connection = getConnection();
        var id = runner.query(connection, SQLStatus, new ScalarHandler<String>());
        return id;
    }

    @SneakyThrows
    public static String getPaymentOrderEntityId() {
    ...
    @SneakyThrows
    public static String getPaymentIdInfo() {
    ...
    @SneakyThrows
    public static String getCreditOrderEntityId() {
    ...
    @SneakyThrows
    public static String getCreditIdInfo() {
